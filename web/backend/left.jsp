...
<div  style="height:100%;">
  <ul id="navigation">
    <li> <a class="head">文章管理</a>
      <ul>
        <li><a href="/backend/article" target="rightFrame">查询文章</a></li>
    ...
    <li> <a class="head">频道管理</a>
      <ul>
        <li><a href="/backend/channel" target="rightFrame">查询频道</a></li>
        <li><a href="/backend/channel?method=addInput" target="rightFrame">添加频道</a></li>
      </ul>
    </li>
